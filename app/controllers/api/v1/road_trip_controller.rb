class Api::V1::RoadTripController < ApplicationController
  def create
    ...
    if travel_time
      ...
      render json: RoadTripSerializer.trip_info(travel_time, params[:origin], params[:destination], arrival_weather)
    else
      render json: RoadTripSerializer.no_route(travel_time, params[:origin], params[:destination], arrival_weather)
    end
  end
end
